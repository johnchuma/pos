...
class MoreCategoryProducts extends StatelessWidget {
   MoreCategoryProducts({super.key});
   BusinessController businessController = Get.find<BusinessController>();
ClientsController clientsController = Get.find<ClientsController>();

  @override
  Widget build(BuildContext context) {
    return  GetBuilder<PublicProductsController>(
          ...
          title: Row(children: [
            ...
            Expanded(child: Column(
              ...
              children: [
                heading2(text:translatedText("${find.selectedCategory.toString().replaceAll("store", "products")} ", "Maulizo ya bidhaa")),
  ...
  ClipRRect(
               ...
               SizedBox(height: 20,),
                          ...
                          FutureBuilder(
                            future: find.getMoreCategoryProducts(),
