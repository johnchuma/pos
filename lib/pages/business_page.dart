...
import 'package:pos/controllers/business_conversation_page.dart';
...
Get.put(ProductVariantsController());
    find.calculateRemainedSubscriptionDays().then((value){
      if(value<10){
Get.defaultDialog(title: "",titlePadding: EdgeInsets.all(0),
            ...
            body: SingleChildScrollView(
              child: Padding(
                ...
                child:  Column(
                    ...
                    GetX<NotificationController>(
                      ...
                      builder: (find) {
                        return GestureDetector(
                          onTap: (){
                               Get.to(()=>BusinessConversationsPage());
                          },
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                mutedText(text: "Click here to check messages",color: primaryColor),
                  ...
                  if(permissions.contains("Manage staffs") || find.selectedRegister.value == null)   
                  menuItem(title:translatedText("Staffs", "Wafanyakazi"),
                    onTap: (){
                      Get.to(()=>const WorkersPage());
                    },
                    subtitle: translatedText("Add, delete and manage staffs here", "Ongeza, futa au rekebisha taarifa hapa")),
                  ...
                  menuItem(title:translatedText("Suppliers", "Wasambazaji") ,
                    ...
                    subtitle:  translatedText("Add, delete and manage suppliers here", "Ongeza, futa au rekebisha taarifa hapa")),
                      if(permissions.contains("Manage suppliers") || find.selectedRegister.value == null) 
                     find.selectedBusiness.value.latitude == 0 ?Column(
                      children: [
                          SizedBox(height: 10,),
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          heading2(text:translatedText("Activate staff attendance", "Wezesha kunakili mahudhurio ya mfanyakazi") ,color: Colors.green[800]),
                                          paragraph(text: translatedText("To activate staff attendance feature go to business settings and find coordinates", "Kuwezesha, nenda kwenye mipangilio ya biashara kisha tafuta coordinates")),
                                        ],
                                      ),
                                    ),),
                                ),
                  ...
                  if(permissions.contains("Manage orders") || find.selectedRegister.value == null)  menuItem(title:translatedText("Orders", "Agiza bidhaa"),
                    ...
                    subtitle:  translatedText("Create orders and share with suppliers here", "Agiza bidhaa kutoka kwa wasambazaji wako") ),
                             if(permissions.contains("Sales reports") || find.selectedRegister.value == null)   
                    ...
                    subtitle: translatedText("View sales report for any date here", "Ona report za mauzo za terehe mbalimbali hapa")),
                       if(permissions.contains("View reports") || find.selectedRegister.value == null)
