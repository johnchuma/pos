...
class ProductRequestsFromClients extends StatefulWidget {
  const ProductRequestsFromClients({super.key});

  @override
  State<ProductRequestsFromClients> createState() => _ProductRequestsFromClientsState();
}

class _ProductRequestsFromClientsState extends State<ProductRequestsFromClients> {
  bool expanded = false;
