    ...
    return  Scaffold(
      ...
      title: Row(children: [
        Expanded(child: Column(
          ...
          children: [
            heading2(text: "Out of stock products"),
          ],
        ))
      ],) 
      ,),
                      ...
                      duration: Duration(milliseconds: 300),
                       ...
                       GetX<ProductController>(
                        init: ProductController(),
                         builder: (find2) {
                           return Column(children:find2.productsWithStock.where((element) => element.name.toLowerCase().contains(find.searchKeyword.value.toLowerCase())).where((product) => product.availableStock  == 0.0 ).map((product) => Padding(
