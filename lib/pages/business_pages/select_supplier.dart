              ...
              child: Padding(
                ...
                child: Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Obx(()=> Checkbox(value: supplierOrderController.selectedSupplier.value == null, onChanged: (value){
                                    supplierOrderController.selectedSupplier.value = null;
                            ...
                            children: find.suppliers.map((item)=>Padding(
                              ...
                              Obx(()=>
                                 Checkbox(
                                  ...
                                  value:supplierOrderController.selectedSupplier.value==null?false:supplierOrderController.selectedSupplier.value?.id == item.id?true:false, onChanged: (value){
                                  
                                    if(value == true){
                                  supplierOrderController.selectedSupplier.value = item;
                  ...
                  setState(() {
                    ...
                    supplierOrderController.addSupplierOrder().then((value) {
                      setState(() {
                    loading = false;
                    Get.back();
                    Get.back();
